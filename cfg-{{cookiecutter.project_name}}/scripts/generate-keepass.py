...
kp.add_entry(kp.root_group, 'SSH Keypair Configuration', username='', password=secrets.get('configuration_git_private_key'))
kp.add_entry(kp.root_group, 'SSH Keypair Operator', username='', password=secrets.get('operator_private_key'))
